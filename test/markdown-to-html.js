...
tape_1.default("transforms heading text to ids for anchor links", t => {
    t.equal(markdown_to_html_1.default("# Heading 1"), '<h1 id="heading-1">Heading 1 <a class="heading-anchor-permalink" href="#heading-1" aria-hidden="true">#</a></h1>\n');
    t.end();
});
